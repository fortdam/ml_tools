function [predictFunc, J_history] = gradientDescentNorm(X, y, initial_theta, lambda, type, alpha, num_iters)
%-------------------------------------------------------------------------
...
%-------------------------------------------------------------------------
  ...
  [theta, J_history] = gradientDescent(X, y, initial_theta, lambda, type, alpha, num_iters);
